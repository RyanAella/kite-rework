export class ContinuePopUp extends HTMLElement {

  static create(novel, novelScene) {
    const continuePopUp = document.createElement('continue-pop-up');
    continuePopUp.novel = novel;
    continuePopUp.novelScene = novelScene;
  ...
  resolveEvent() {
    this.dispatchEvent(new CustomEvent("resolve-event", {
      bubbles : true
    }));
  }
}
